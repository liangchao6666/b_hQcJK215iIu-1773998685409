...
const cases = [
  {
    id: 1,
    title: "金融行业",
    description: "为银行提供中间件统一管理服务，实现对应用服务器、消息中间件等的集中监控和管理。",
    image: "/images/cases/case-1.png",
  },
  {
    id: 2,
    title: "电商平台",
    description: "为电商网站提供中间件统一管理服务，确保中间件系统的稳定运行和性能优化。",
    image: "/images/cases/case-2.png",
  },
  {
    id: 3,
    title: "电信运营商",
    description: "为电信业务提供中间件统一管理服务，实现对分布式中间件集群的有效管理。",
    image: "/images/cases/case-3.png",
  },
  {
    id: 4,
    title: "政府部门",
    description: "为政务服务提供中间件统一管理服务，确保政务系统的安全稳定运行。",
    image: "/images/cases/case-4.png",
  },
  {
    id: 5,
    title: "制造业",
    description: "为制造企业提供中间件统一管理服务，实现对生产系统中间件的实时监控和管理。",
    image: "/images/cases/case-5.png",
  },
  {
    id: 6,
    title: "医疗健康",
    description: "为医疗机构提供中间件统一管理服务，确保医疗信息系统的稳定运行和数据安全。",
