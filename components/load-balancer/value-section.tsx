...
const valueItems = [
  {
    ...
    nextLine1: "智能负载",
    nextLine2: "均衡",
    description: "采用高效的负载均衡算法和优化的网络处理机制，支持每秒数万级的请求处理能力，为企业应用提供高性能的流量分发服务。",
  ...
  },
  {
    ...
    nextLine1: "高可用",
    nextLine2: "",
    description: "支持多种负载均衡算法，包括轮询、加权轮询、IP哈希、最小连接数等，可根据应用场景自动选择最佳的负载均衡策略。",
  ...
  },
  {
    ...
    nextLine1: "健康检查",
    nextLine2: "",
    description: "支持多种健康检查方式，包括TCP、HTTP、HTTPS等，能够实时监控后端服务器状态，自动剔除故障节点，确保服务持续可用。",
  ...
  },
  {
    ...
    nextLine1: "会话保持",
    nextLine2: "",
    description: "提供多种会话保持机制，包括基于Cookie、IP、SSL会话ID等方式，确保用户会话的连续性，提升用户体验。",
  ...
  },
  {
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "支持与主流应用服务器、云平台和容器环境的无缝集成，提供简单易用的配置界面和API，降低部署和管理成本。",
  ...
  },
  {
    ...
    nextLine1: "高性能",
    nextLine2: "",
    description: "提供丰富的监控和管理功能，支持实时查看系统状态、流量统计和日志分析，帮助运维人员快速定位和解决问题。",
