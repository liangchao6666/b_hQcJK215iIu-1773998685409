...
const cases = [
  {
    id: 1,
    title: "金融行业",
    description: "为银行核心系统提供可靠的消息传递服务，确保交易数据的安全传输和处理。",
    image: "/images/cases/case-1.png",
  },
  {
    id: 2,
    title: "电商平台",
    description: "为电商网站提供订单处理和库存管理的消息传递服务，提升系统响应速度。",
    image: "/images/cases/case-2.png",
  },
  {
    id: 3,
    title: "电信运营商",
    description: "为电信业务系统提供实时消息传递服务，支持高并发的业务处理。",
    image: "/images/cases/case-3.png",
  },
  {
    id: 4,
    title: "政府部门",
    description: "为政务服务平台提供安全可靠的消息传递服务，确保政务数据的及时处理。",
    image: "/images/cases/case-4.png",
  },
  {
    id: 5,
    title: "制造业",
    description: "为智能制造系统提供生产数据的实时传递服务，支持生产过程的监控和管理。",
    image: "/images/cases/case-5.png",
  },
  {
    id: 6,
    title: "医疗健康",
    description: "为医疗信息系统提供患者数据的安全传递服务，确保医疗信息的及时共享。",
