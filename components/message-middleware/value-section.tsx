...
const valueItems = [
  {
    ...
    nextLine1: "多种消息模式",
    nextLine2: "",
    description: "采用高效的消息存储和传输机制，支持每秒数十万级的消息处理能力，为企业应用提供快速的消息传递服务。",
  ...
  },
  {
    ...
    nextLine1: "高可靠",
    nextLine2: "",
    description: "支持点对点、发布/订阅、请求/响应等多种消息模式，满足不同业务场景的消息传递需求。",
  ...
  },
  {
    ...
    nextLine1: "持久化存储",
    nextLine2: "",
    description: "提供消息持久化、事务支持、集群容错等机制，确保消息不丢失，系统稳定运行。",
  ...
  },
  {
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "支持消息持久化到磁盘，确保系统重启后消息不丢失，提高系统可靠性。",
  ...
  },
  {
    ...
    nextLine1: "高性能",
    nextLine2: "",
    description: "提供全面的监控和管理功能，支持实时查看消息队列状态、性能指标和操作日志，帮助运维人员快速定位和解决问题。",
