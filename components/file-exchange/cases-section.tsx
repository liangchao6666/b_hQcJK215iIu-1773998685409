...
const cases = [
  {
    id: 1,
    title: "金融行业",
    description: "为银行提供安全的文件交换服务，实现与监管机构、合作伙伴的安全文件传输。",
    image: "/images/cases/case-1.png",
  },
  {
    id: 2,
    title: "电商平台",
    description: "为电商网站提供大文件交换服务，实现供应商和商家之间的文件共享和传输。",
    image: "/images/cases/case-2.png",
  },
  {
    id: 3,
    title: "电信运营商",
    description: "为电信业务提供文件交换服务，实现与合作伙伴和客户之间的安全信息共享。",
    image: "/images/cases/case-3.png",
  },
  {
    id: 4,
    title: "政府部门",
    description: "为政务服务提供文件交换服务，实现政府部门之间的安全信息共享和传输。",
    image: "/images/cases/case-4.png",
  },
  {
    id: 5,
    title: "制造业",
    description: "为制造企业提供文件交换服务，实现与供应商、客户之间的技术文档和设计文件传输。",
    image: "/images/cases/case-5.png",
  },
  {
    id: 6,
    title: "医疗健康",
    description: "为医疗机构提供文件交换服务，实现患者医疗记录和影像资料的安全传输。",
