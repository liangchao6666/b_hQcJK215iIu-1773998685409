...
const valueItems = [
  {
    ...
    nextLine1: "安全加密",
    nextLine2: "",
    description: "支持GB级大文件的快速传输，满足企业各种文件交换需求。",
    icon: "/images/file-exchange/value-1.png",
  },
  {
    title: "安全加密",
    circleLine1: "安全",
    ...
    nextLine1: "权限控制",
    nextLine2: "",
    description: "采用多种加密技术，确保文件传输和存储的安全性。",
    icon: "/images/file-exchange/value-2.png",
  },
  {
    title: "权限控制",
    circleLine1: "权限",
    ...
    nextLine1: "审计追踪",
    nextLine2: "",
    description: "提供细粒度的权限控制，确保只有授权用户能够访问和操作文件。",
    icon: "/images/file-exchange/value-3.png",
  },
  {
    title: "审计追踪",
    circleLine1: "审计",
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "提供详细的操作审计日志，支持文件传输和访问的全过程追踪。",
    icon: "/images/file-exchange/value-4.png",
  },
  {
    title: "易于集成",
    circleLine1: "易于",
    ...
    icon: "/images/file-exchange/value-5.png",
  },
  {
    title: "高可靠性",
    circleLine1: "高可靠",
    ...
    nextLine1: "大文件传输",
    nextLine2: "",
    description: "采用多种技术确保文件传输的可靠性，支持断点续传和失败重试。",
    icon: "/images/file-exchange/value-6.png",
  },
]
