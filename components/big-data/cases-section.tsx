...
const cases = [
  {
    id: 1,
    title: "金融行业",
    description: "为银行提供大数据分析服务，实现客户行为分析、风险评估、反欺诈等功能。",
    image: "/images/cases/case-1.png",
  },
  {
    id: 2,
    title: "电商平台",
    description: "为电商网站提供大数据分析服务，实现用户行为分析、个性化推荐、库存优化等功能。",
    image: "/images/cases/case-2.png",
  },
  {
    id: 3,
    title: "电信运营商",
    description: "为电信业务提供大数据分析服务，实现用户画像、网络优化、套餐推荐等功能。",
    image: "/images/cases/case-3.png",
  },
  {
    id: 4,
    title: "政府部门",
    description: "为政务服务提供大数据分析服务，实现人口分析、交通管理、城市规划等功能。",
    image: "/images/cases/case-4.png",
  },
  {
    id: 5,
    title: "制造业",
    description: "为制造企业提供大数据分析服务，实现生产优化、质量控制、设备预测性维护等功能。",
    image: "/images/cases/case-5.png",
  },
  {
    id: 6,
    title: "医疗健康",
    description: "为医疗机构提供大数据分析服务，实现患者分析、疾病预测、医疗资源优化等功能。",
