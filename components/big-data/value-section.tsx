...
const valueItems = [
  {
    ...
    nextLine1: "数据存储",
    nextLine2: "",
    description: "支持PB级数据的处理和分析，能够应对企业日益增长的数据量需求。",
    icon: "/images/big-data/value-1.png",
  },
  {
    title: "数据存储",
    circleLine1: "数据",
    ...
    nextLine1: "数据分析",
    nextLine2: "",
    description: "提供高效的数据存储方案，支持结构化和非结构化数据的存储。",
    icon: "/images/big-data/value-2.png",
  },
  {
    title: "数据分析",
    circleLine1: "数据",
    ...
    nextLine1: "数据可视化",
    nextLine2: "",
    description: "提供丰富的数据分析工具和算法，支持多种分析场景和需求。",
    icon: "/images/big-data/value-3.png",
  },
  {
    title: "数据可视化",
    circleLine1: "数据",
    ...
    nextLine1: "智能洞察",
    nextLine2: "",
    description: "提供丰富的数据可视化组件，支持直观的数据展示和交互分析。",
    icon: "/images/big-data/value-4.png",
  },
  {
    title: "智能洞察",
    circleLine1: "智能",
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "结合AI技术，提供智能的数据洞察和预测分析能力。",
    icon: "/images/big-data/value-5.png",
  },
  {
    title: "易于集成",
    circleLine1: "易于",
    ...
    icon: "/images/big-data/value-6.png",
  },
]
