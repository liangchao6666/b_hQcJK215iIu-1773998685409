...
const cases = [
  {
    id: 1,
    title: "金融行业",
    description: "为银行提供核心系统与外围系统的集成服务，实现数据的实时共享和业务流程的自动化。",
    image: "/images/cases/case-1.png",
  },
  {
    id: 2,
    title: "电商平台",
    description: "为电商网站提供订单系统、支付系统、物流系统等的集成服务，提升系统的协同效率。",
    image: "/images/cases/case-2.png",
  },
  {
    id: 3,
    title: "电信运营商",
    description: "为电信业务提供BOSS系统、CRM系统、计费系统等的集成服务，实现业务的快速响应。",
    image: "/images/cases/case-3.png",
  },
  {
    id: 4,
    title: "政府部门",
    description: "为政务服务提供各部门系统的集成服务，实现政务数据的共享和业务的协同办理。",
    image: "/images/cases/case-4.png",
  },
  {
    id: 5,
    title: "制造业",
    description: "为制造企业提供ERP、MES、PLM等系统的集成服务，实现生产数据的实时采集和分析。",
    image: "/images/cases/case-5.png",
  },
  {
    id: 6,
    title: "医疗健康",
    description: "为医疗机构提供HIS、PACS、EMR等系统的集成服务，实现医疗信息的共享和协同诊疗。",
