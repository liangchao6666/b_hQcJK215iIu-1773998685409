...
const cases = [
  {
    id: 1,
    title: "金融行业",
    description: "为银行提供数据传输服务，实现银行内部系统之间的数据交换和共享。",
    image: "/images/cases/case-1.png",
  },
  {
    id: 2,
    title: "电商平台",
    description: "为电商网站提供数据传输服务，实现订单、库存、物流等数据的实时传输。",
    image: "/images/cases/case-2.png",
  },
  {
    id: 3,
    title: "制造业",
    description: "为制造企业提供数据传输服务，实现生产数据、设备数据的实时采集和传输。",
    image: "/images/cases/case-3.png",
  },
  {
    id: 4,
    title: "医疗健康",
    description: "为医疗机构提供数据传输服务，实现医疗数据的安全传输和共享。",
    image: "/images/cases/case-4.png",
  },
  {
    id: 5,
    title: "政府部门",
    description: "为政务服务提供数据传输服务，实现政府各部门之间的数据交换和共享。",
    image: "/images/cases/case-5.png",
  },
  {
    id: 6,
    title: "物流行业",
    description: "为物流企业提供数据传输服务，实现物流信息的实时传输和跟踪。",
