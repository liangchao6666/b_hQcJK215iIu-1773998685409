...
const valueItems = [
  {
    ...
    nextLine1: "安全传输",
    nextLine2: "",
    description: "支持多种数据传输协议，包括HTTP、HTTPS、FTP、SFTP、WebSocket等，满足不同场景的传输需求。",
    icon: "/images/dtp/value-1.png",
  },
  {
    title: "安全传输",
    circleLine1: "安全",
    ...
    nextLine1: "高效传输",
    nextLine2: "",
    description: "提供端到端的加密传输，确保数据传输过程中的安全性，防止数据泄露和篡改。",
    icon: "/images/dtp/value-2.png",
  },
  {
    title: "高效传输",
    circleLine1: "高效",
    ...
    nextLine1: "可靠传输",
    nextLine2: "",
    description: "采用先进的数据传输算法，提高传输速度和效率，减少传输时间和网络带宽消耗。",
    icon: "/images/dtp/value-3.png",
  },
  {
    title: "可靠传输",
    circleLine1: "可靠",
    ...
    nextLine1: "智能调度",
    nextLine2: "",
    description: "支持断点续传、错误重传等机制，确保数据传输的可靠性，避免数据丢失。",
    icon: "/images/dtp/value-4.png",
  },
  {
    title: "智能调度",
    circleLine1: "智能",
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "智能调度传输任务，根据网络状况和系统负载自动调整传输策略，提高传输效率。",
    icon: "/images/dtp/value-5.png",
  },
  {
    title: "易于集成",
    circleLine1: "易于",
    ...
    nextLine1: "多种传输协议",
    nextLine2: "",
    description: "支持与企业现有系统的集成，提供丰富的API和接口，方便系统对接。",
    icon: "/images/dtp/value-6.png",
  },
]
