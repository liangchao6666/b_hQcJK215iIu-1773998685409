...
const valueItems = [
  {
    ...
    nextLine1: "智能任务分配",
    nextLine2: "",
    description: "提供直观的可视化流程设计工具，支持拖拽式流程建模，降低流程设计门槛，提高设计效率。",
  ...
  },
  {
    ...
    nextLine1: "灵活的流程定义",
    nextLine2: "",
    description: "支持多种任务分配策略，包括基于规则的自动分配、人工分配等，提高任务处理效率。",
  ...
  },
  {
    ...
    nextLine1: "全面的监控分析",
    nextLine2: "",
    description: "支持复杂的流程逻辑，包括分支、合并、循环等，满足不同业务场景的需求。",
  ...
  },
  {
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "提供实时的流程监控和分析功能，支持流程绩效分析、瓶颈识别等，帮助企业优化业务流程。",
  ...
  },
  {
    ...
    nextLine1: "高可靠",
    nextLine2: "",
    description: "提供丰富的API和标准协议支持，易于与各种应用系统集成，降低集成成本。",
  ...
  },
  {
    ...
    nextLine1: "可视化流程设计",
    nextLine2: "",
    description: "提供流程实例的持久化、事务支持、错误处理等机制，确保流程的可靠执行。",
