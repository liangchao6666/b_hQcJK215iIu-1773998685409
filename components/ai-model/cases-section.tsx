...
const cases = [
  {
    id: 1,
    title: "金融行业",
    description: "为银行提供AI模型管理服务，实现风控模型、客户画像模型等的全生命周期管理。",
    image: "/images/cases/case-1.png",
  },
  {
    id: 2,
    title: "电商平台",
    description: "为电商网站提供AI模型管理服务，实现推荐系统模型、搜索模型等的高效管理。",
    image: "/images/cases/case-2.png",
  },
  {
    id: 3,
    title: "制造行业",
    description: "为制造企业提供AI模型管理服务，实现预测性维护模型、质量控制模型等的管理。",
    image: "/images/cases/case-3.png",
  },
  {
    id: 4,
    title: "医疗健康",
    description: "为医疗机构提供AI模型管理服务，实现医疗影像分析模型、疾病预测模型等的管理。",
    image: "/images/cases/case-4.png",
  },
  {
    id: 5,
    title: "零售行业",
    description: "为零售企业提供AI模型管理服务，实现库存预测模型、销售预测模型等的管理。",
    image: "/images/cases/case-5.png",
  },
  {
    id: 6,
    title: "物流行业",
    description: "为物流企业提供AI模型管理服务，实现路径优化模型、配送时间预测模型等的管理。",
