...
const valueItems = [
  {
    ...
    nextLine1: "模型部署",
    nextLine2: "",
    description: "支持多种AI模型的注册和管理，建立模型资产库，实现模型的统一管理。",
    icon: "/images/ai-model/value-1.png",
  },
  {
    title: "模型部署",
    circleLine1: "模型",
    ...
    nextLine1: "模型监控",
    nextLine2: "",
    description: "提供模型的快速部署能力，支持多种部署方式，包括容器化部署和云端部署。",
    icon: "/images/ai-model/value-2.png",
  },
  {
    title: "模型监控",
    circleLine1: "模型",
    ...
    nextLine1: "版本管理",
    nextLine2: "",
    description: "实时监控模型的运行状态和性能指标，及时发现和处理模型异常。",
    icon: "/images/ai-model/value-3.png",
  },
  {
    title: "版本管理",
    circleLine1: "版本",
    ...
    nextLine1: "A/B测试",
    nextLine2: "",
    description: "支持模型的版本管理，跟踪模型的变更历史，方便模型的回滚和对比。",
    icon: "/images/ai-model/value-4.png",
  },
  {
    title: "A/B测试",
    circleLine1: "A/B",
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "支持模型的A/B测试，通过对比不同模型的性能，选择最优模型。",
    icon: "/images/ai-model/value-5.png",
  },
  {
    title: "易于集成",
    circleLine1: "易于",
    ...
    icon: "/images/ai-model/value-6.png",
  },
]
