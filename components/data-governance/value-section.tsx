...
const valueItems = [
  {
    ...
    nextLine1: "数据血缘分析",
    nextLine2: "",
    description: "自动发现和盘点企业数据资产，建立数据资产目录，实现数据资产的可视化管理。",
    icon: "/images/data-governance/value-1.png",
  },
  {
    title: "数据血缘分析",
    circleLine1: "数据血缘",
    ...
    nextLine1: "数据质量评估",
    nextLine2: "",
    description: "追踪数据的来源和流向，建立数据血缘关系，帮助企业了解数据的来龙去脉。",
    icon: "/images/data-governance/value-2.png",
  },
  {
    title: "数据质量评估",
    circleLine1: "数据质量",
    ...
    nextLine1: "数据安全管理",
    nextLine2: "",
    description: "提供多维度的数据质量评估，识别数据质量问题，支持数据质量的持续改进。",
    icon: "/images/data-governance/value-3.png",
  },
  {
    title: "数据安全管理",
    circleLine1: "数据安全",
    ...
    nextLine1: "数据标准管理",
    nextLine2: "",
    description: "提供数据安全管控能力，包括数据脱敏、访问控制、审计追踪等功能。",
    icon: "/images/data-governance/value-4.png",
  },
  {
    title: "数据标准管理",
    circleLine1: "数据标准",
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "建立和管理企业数据标准，确保数据的一致性和规范性。",
    icon: "/images/data-governance/value-5.png",
  },
  {
    title: "易于集成",
    circleLine1: "易于",
    ...
    nextLine1: "数据资产盘点",
    nextLine2: "",
    description: "支持与企业现有系统的集成，提供丰富的API和接口。",
    icon: "/images/data-governance/value-6.png",
  },
]
