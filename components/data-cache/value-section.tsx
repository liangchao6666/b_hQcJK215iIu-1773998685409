...
const valueItems = [
  {
    ...
    nextLine1: "分布式架构",
    nextLine2: "",
    description: "采用高效的内存管理和网络传输机制，支持每秒数十万级的缓存操作，为企业应用提供快速的数据访问能力。",
  ...
  },
  {
    ...
    nextLine1: "高可靠",
    nextLine2: "",
    description: "支持集群部署，提供自动数据分片和负载均衡能力，可根据业务需求弹性扩展，满足不同规模的应用场景。",
  ...
  },
  {
    ...
    nextLine1: "多种缓存策略",
    nextLine2: "",
    description: "提供数据持久化、主从复制、集群容错等机制，确保缓存服务的高可用性和数据安全性，避免单点故障。",
  ...
  },
  {
    ...
    nextLine1: "易于集成",
    nextLine2: "",
    description: "支持多种缓存过期策略和数据淘汰机制，包括LRU、LFU、FIFO等，可根据业务场景灵活配置。",
  ...
  },
  {
    ...
    nextLine1: "监控管理",
    nextLine2: "",
    description: "提供丰富的客户端API和标准协议支持，易于与各种应用框架和开发语言集成，降低使用成本。",
  ...
  },
  {
    ...
    nextLine1: "高性能",
    nextLine2: "",
    description: "提供全面的监控和管理功能，支持实时查看缓存状态、性能指标和操作日志，帮助运维人员快速定位和解决问题。",
